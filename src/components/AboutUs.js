        ...
        <section className='aboutus-container' id='about'>
            <div className='about-aos' data-aos='fade-up'>
                <div className='aboutus-info' >
                    <h3>Why Us</h3>
                    <h1>Serving you a great time</h1>
                    <p className='aboutus-p'>Our mission is to give our customers a place to celebrate life’s special moments by offering the best food, service, and ambiance. The smile on our customers face has always been our first priority and we work hard to achieve that. </p>
